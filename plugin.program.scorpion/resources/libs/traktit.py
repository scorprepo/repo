...
ORDER          = ['scorpion', 'jorel', 'seren', 'exodusr', 'clowns', 'eimraith', 'metalk', 'uranus', 'numers', 'krotas', 'chappaai', 'gmetalliq', 'benel', 'trakt']
...
TRAKTID = { 
	'exodusr': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'exodusr_trakt'),
 ...
 'scorpion': {
		'name'     : 'Scorpion Streams',
		'plugin'   : 'plugin.video.Scorpion',
		'saved'    : 'scorpion',
		'path'     : os.path.join(ADDONS, 'plugin.video.Scorpion'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.Scorpion', 'icon.jpg'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.Scorpion', 'fanart.png'),
		'file'     : os.path.join(TRAKTFOLD, 'scorpion_trakt'),
		'settings' : os.path.join(ADDOND, 'plugin.video.Scorpion', 'settings.xml'),
		'default'  : 'trakt.user',
		'data'     : ['trakt.user', 'trakt.refresh', 'trakt.token'],
		'activate' : 'RunPlugin(plugin://plugin.video.Scorpion/?action=authTrakt)'},
   'jorel': {
		'name'     : 'Jor-El',
...
'clowns': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'clowns_trakt'),
