...
ORDER          = ['vaders', 'smoothstreams', 'power', 'mcktv', 'pttp', 'sportsmania', 'sportsnationhdtv', 'ultimatemania', 'gears', 'flawless', 'sportsaccess', 'limitless', 'otttv', 'ontapptv',]
...
LOGINID = {
  'sportsaccess': {
	...
	'power': {
		...
		'file'     : os.path.join(LOGINFOLD, 'power_login'),
  ...
  'pttp': {
		...
		'plugin'   : 'plugin.video.pttp',
		'saved'    : 'loginpttp',
		'path'     : os.path.join(ADDONS, 'plugin.video.pttp'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.pttp', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.pttp', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'pttp_login'),
		'settings' : os.path.join(ADDOND, 'plugin.video.pttp', 'settings.xml'),
		'default'  : 'Username',
		'data'     : ['Username', 'Password'],
		'activate' : ''},
	'sportsmania': {
