# -*- coding: utf-8 -*-
# --[ YourSports v1.0 ]--|--[ From JewBMX & Scorpion ]--
...
class yoursports:
    ...
    def root(self):
        channels = [
            ...
            ('Action Sports', '/ing/tvx2?ch=action4u', 'https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-thumbnail/s3/0014/7209/brand.gif?itok=Z-Zmkz4t'),
            ('ADS SPORTS', '/ing/tvx2?ch=adssport', 'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/d4956f38795421.576fa418378b9.jpg'),
            ...
            ('BEIN SPORTS (US IP)', '/ing/dsh?ch=bein', 'https://cdn.bein.net/bmg/wp-content/uploads/2015/03/beIN-SPORTS-LOGO.png'),
            ('BEIN SPORTS EXTRA', '/ing/tvx2?ch=beinxtra', 'https://beinsportsxtra.com/images/icons/logo/beIN-SPORTS-XTRA_LOGO.png'),
            ('BEK SPORTS EAST', '/ing/tvx2?ch=bekeast', 'https://www.ndhsaanow.com/uploads/images/bek_sports_LOGO.jpg'),
            ('BEK SPORTS WEST', '/ing/tvx2?ch=bekwest', 'https://www.ndhsaanow.com/uploads/images/bek_sports_LOGO.jpg'),
            ...
            ('ERTSPORTS', '/ing/tvx2?ch=ertsports', 'https://www.canlisportv.com/media/images/tvlogo/4716c28f-0d37-4bf2-8c59-dd4f921d50b5_ert-sports.png'),
            ...
            ('FOX SOCCER PLUS', '/ing/fsplus', 'https://upload.wikimedia.org/wikipedia/en/d/d7/FSPlus_New2011.jpg'),
            ...
            ('Fox Sports ARI (US IP)', '/ing/fxpla?y=fsari', 'https://b.fssta.com/uploads/content/dam/fsdigital/RSN/Arizona/2014/1/2/PI-FOX-Sports-Arizona-Logo.vresize.1200.630.high.0.jpg'),
            ...
            ('FOX SPORTS FLA (US IP)', '/ing/fxpla?y=fsfla', 'https://cdn.chatsports.com/cache/51/81/5181cfe9b651803f88686bc6ea14fb0f-original.jpg'),
            ('FOX SPORTS KANSAS (US IP)', '/ing/fxpla?y=fskn', 'https://www.killthecablebill.com/images/cancelcable/watch-fox-sports-kansas-city-without-cable-1024x576.png'),
            ...
            ('FOX SPORTS NORTH (US IP)', '/ing/fxpla?y=fsn', 'https://b.fssta.com/uploads/content/dam/fsdigital/RSN/North/2014/04/25/PI-FOX-Sports-North-FSN-logo.jpg'),
            ('FOX SPORTS OHIO (US IP)', '/ing/fxpla?y=fsoh',  'https://foxsports-wordpress-www-prsupports-prod.s3.amazonaws.com/uploads/sites/2/2016/12/FSOhio_white.jpg'),
            ('FOX SPORTS OK (US IP)', '/ing/fxpla?y=fsok', 'https://www.killthecablebill.com/images/cancelcable/watch-fox-sports-oklahoma-without-cable-1024x576.png'),
            ('FOX SPORTS PRIME (US IP)', '/ing/fxpla?y=fsprime', 'https://foxsports-wordpress-www-prsupports-prod.s3.amazonaws.com/uploads/sites/2/2016/12/images-1.jpeg'),
            ('FOX SPORTS SOCCER (US IP)', '/ing/fxpla?y=foxsoccer', 'https://2.bp.blogspot.com/-RCCK_8-AsrY/Tffjb_3nVaI/AAAAAAAABlY/NVcwSRXxClM/s1600/Fox+Soccer+logo+2011.jpg'),
            ('FOX SPORTS SOUTHEAST (US IP)', '/ing/fxpla?y=fsse', 'https://upload.wikimedia.org/wikipedia/en/8/8d/Fox_Sports_Southeast_2015_logo.jpeg'),
            ('FOX SPORTS SOUTHEAST MEMPHIS (US IP)', '/ing/fxpla?y=fsmem', 'https://www.nba.com/grizzlies/sites/grizzlies/files/fox-sports-southeast-777x442.jpg?w=756&h=430'),
            ('FOX SPORTS SOUTHWEST (US IP)', '/ing/fxpla?y=fsdal', 'https://lh3.googleusercontent.com/proxy/nBYRKneECv1pqol7vYAB83hMI2rQjVqGa8jI1kO3aCBDv2r8ttoVA9I1G7amMSPrTHDewvsNzLEjGfbqTUPOf0evefmc1O-5mBlyxVcJiFAvbB335zcCryVj32n5l6yxZ9EamIWBsThgGsZ7b1wU-nBETq44ik81Hj3UaBQOyi-wO-z3zDOOmRm8jBx0Ap9JTgiGh7uel_mmuoIQqlvXUR0yb9gv0Vn1'),
            ('FOX SPORTS SUN (US IP)', '/ing/fxpla?y=fssun', 'https://www.p1jetcross.com/uploads/images/large/z-Jetcross22506Sponsor1.gif'),
            ('FOX SPORTS WEST (US IP)', '/ing/fxpla?y=fswest', 'https://b.fssta.com/uploads/content/dam/fsdigital/RSN/West/2013/12/26/122613-West-FSW-PI.vresize.1024.576.high.31.jpg'),
            ('FOX SPORTS WIS (US IP)', '/ing/fxpla?y=fswis', 'https://pbs.twimg.com/profile_images/1232047445577785344/w2jll1Cf_400x400.jpg'),
            ('FOX SPORTS YES (US IP)', '/ing/fxpla?y=fsyes', 'https://lh3.googleusercontent.com/proxy/iP9OCq70HrLnI8uPFXlDmsS8npCEvRs5dxEMnJOiwRfo9TJBEYA7U0yWAOtmuwO2DKGs8OOFDpLFLkjHj7dPwlTFBqgRp7DiGVPcHfHCA-8PEIilQyH0-4ZeAwan44D8fg'),
            ('FS1 ASIA', '/ing/fxpla?y=fs1asia', 'https://foxsports-wordpress-www-prsupports-prod.s3.amazonaws.com/uploads/sites/2/2017/08/FS2-Logo_1040x585-354x200.jpg'),
            ('FS2 ASIA', '/ing/fxpla?y=fs2asia', 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQPaWQ9LxPVdMpZ3fdM9e3sLvb_-dyqM55fb4DorrLrs5nk6_MA'),
            ...
            ('FREEFORM', '/ing/freeform', 'https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-thumbnail/s3/032018/untitled-1_364.png?LQDe5V1vtSFxICGBNN_Cns3I2MFHaPNM&itok=LZKjEe-_'),
