...
class movies:
    def __init__(self):
        ...
        self.premiere_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie&languages=en&num_votes=1000,&release_date=date[90],date[0]&sort=moviemeter,asc&count=40&start=1'
        ...
        self.trending_link = 'https://api.trakt.tv/movies/trending?page=1&limit=40'
        ...
        self.votes_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=1000,&production_status=released&sort=num_votes,desc&count=40&start=1'
        ...
        self.trakthistory_link = 'https://api.trakt.tv/users/me/history/movies?page=1&limit=40'
            ...
            try:
                ...
                self.list.append(
                    {'title': title, 'originaltitle': title, 'year': year, 'premiered': premiered,
                     ...
                     'plot': plot, 'tagline': tagline, 'imdb': imdb, 'tmdb': tmdb, 'tvdb': '0', 'poster': '0',
                     'next': next})
            except:
                pass
    ...
    def movieDirectory(self, items):
        ...
        control.sleep(1000)
        views.setView('movies', {'skin.scorpion': 54, 'skin.confluence': 500})
    ...
    def addDirectory(self, items, queue=False):
        ...
        for i in items:
            try:
                ...
                cm.append(
                    (playRandom, 'RunPlugin(%s?action=random&rtype=movie&url=%s)' %
                ...
                try:
                    cm.append(
                        (addToLibrary, 'RunPlugin(%s?action=moviesToLibrary&url=%s)' %
