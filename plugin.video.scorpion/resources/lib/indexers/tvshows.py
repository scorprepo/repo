...
class tvshows:
    def __init__(self):
        ...
        self.tvdb_info_link = 'https://thetvdb.com/api/%s/series/%s/%s.zip' % (self.tvdb_key, '%s', self. lang)
        ...
        self.trending_link = 'http://api.trakt.tv/shows/trending?limit=40&page=3'
        self.popular_link = 'https://api.trakt.tv/shows/popular?limit=40&page=10'
        self.featured_link = 'https://api.trakt.tv/shows/watched/weekly?limit=40&page=3'
        self.genre_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&countries=us&languages=en&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.votes_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&countries=us&languages=en&num_votes=100,&release_date=,date[0]&sort=num_votes,desc&count=40&start=1'
        self.year_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&countries=us&languages=en&num_votes=100,&production_status=released&year=%s,%s&sort=moviemeter,asc&count=40&start=1'
        self.rating_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&countries=us&languages=en&num_votes=5000,&release_date=,date[0]&sort=user_rating,desc&count=40&start=1'
        ...
        self.active_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&countries=us&languages=en&num_votes=10,&production_status=active&sort=moviemeter,asc&count=40&start=1'
        self.person_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&countries=us&languages=en&release_date=,date[0]&role=%s&sort=year,desc&count=40&start=1'
        ...
        self.traktcollection_link = 'http://api.trakt.tv/users/me/collection/shows?limit=40&page=3'
        self.traktwatchlist_link = 'http://api.trakt.tv/users/me/watchlist/shows'
        self.traktfeatured_link = 'http://api.trakt.tv/recommendations/shows?limit=40&page=3'
    ...
    def genres(self):
        genres = [
            ('Action', 'action', True, 'Action.png'),
            ('Adventure', 'adventure', True, 'Adventure.png'),
            ('Animation', 'animation', True, 'Animation.png'),
            ('Anime', 'anime', True, 'Anime.png'),
            ('Biography', 'biography', True, 'Biography.png'),
            ('Comedy', 'comedy', True, 'Comedy.png'),
            ('Crime', 'crime', True, 'Crime.png'),
            ('Documentary', 'documentary', True, 'Documentary.png'),
            ('Drama', 'drama', True, 'Drama.png'),
            ('Family', 'family', True, 'Family.png'),
            ('Fantasy', 'fantasy', True, 'Fantasy.png'),
            ('History', 'history', True, 'History.png'),
            ('Horror', 'horror', True, 'Horror.png'),
            ('Music ', 'music', True, 'Music.png'),
            ('Musical', 'musical', True, 'Musical.png'),
            ('Mystery', 'mystery', True, 'Mystery.png'),
            ('Romance', 'romance', True, 'Romance.png'),
            ('Science Fiction', 'sci_fi', True, 'Science Fiction.png'),
            ('Sport', 'sport', True, 'Sport.png'),
            ('Thriller', 'thriller', True, 'Thriller.png'),
            ('War', 'war', True, 'War.png') ,
            ('Western', 'western', True, 'Western.png'),
        ]
    ...
    def networks(self):
        networks = [
            ('A&E', 'https://www.tvmaze.com/networks/29/ae', 'networks/a&e.png'),
            ('ABC', 'http://api.trakt.tv/shows/popular?networks=ABC&limit=100&page=1', 'networks/abc.png'),
            ('AMC', 'http://api.trakt.tv/shows/popular?networks=AMC&limit=100&page=1', 'networks/amc.png'),
            ('Adult Swim', 'http://api.trakt.tv/shows/popular?networks=Adult Swim&limit=100&page=1', 'networks/adultswim.png'),
            ('Amazon', 'http://api.trakt.tv/shows/popular?networks=Amazon&limit=100&page=1', 'networks/amazon.png'),
            ('Animal Planet', 'http://api.trakt.tv/shows/popular?networks=Animal Planet&limit=100&page=1', 'networks/animalplanet.png'),
            ('BBC America', 'http://api.trakt.tv/shows/popular?networks=BBC America&limit=100&page=1', 'networks/bbc.png'),
            ('BBC One', 'http://api.trakt.tv/shows/popular?networks=BBC One&limit=100&page=1', 'networks/bbc1.png'),
            ('BBC Two', 'http://api.trakt.tv/shows/popular?networks=BBC Two&limit=100&page=1', 'networks/bbc2.png'),
            ('BBC Three', 'http://api.trakt.tv/shows/popular?networks=BBC Three&limit=100&page=1', 'networks/bbc3.png'),
            ('BBC Four', 'http://api.trakt.tv/shows/popular?networks=BBC Four&limit=100&page=1', 'networks/bbc4.png'),
            ('Boomerang', 'http://api.trakt.tv/shows/popular?networks=Boomerang&limit=100&page=1', 'networks/boomerang.png'),
            ('Bravo', 'http://tvmaze.com/networks/52/bravo', 'networks/bravo.png'),
            ('CBS', 'http://api.trakt.tv/shows/popular?networks=CBS&limit=100&page=1', 'networks/cbs.png'),
            ('CW', 'https://www.imdb.com/search/title/?title_type=tv_series,tv_special,tv_miniseries,documentary,tv_short&companies=co0174148', 'networks/cw.png'),
            ('CW Seed', 'http://api.trakt.tv/shows/popular?networks=CW&page=1&limit=100', 'networks/cwseed.png'),
            ('CW Seed', 'http://api.trakt.tv/shows/popular?networks=CW Seed&limit=100&page=1', 'networks/cwseed.png'),
            ('Cartoon Network', 'http://api.trakt.tv/shows/popular?networks=Cartoon Network&limit=100&page=1', 'networks/cartoon.png'),
            ('Cinemax', 'http://api.trakt.tv/shows/popular?networks=Cinemax&page=1&limit=100', 'networks/cinemax.png'),
            ('Comedy Central', 'https://www.imdb.com/search/title/?title_type=tv_series,tv_special,tv_miniseries,documentary,tv_short&companies=co0029768&production_status=released&sort=num_votes,desc', 'networks/comedy.png'),
            ('DC', 'http://api.trakt.tv/shows/popular?networks=DC Universe&limit=100&page=1', 'networks/dc.png'),
            ('Discovery Channel', 'http://api.trakt.tv/shows/popular?networks=Discovery&limit=100&page=1', 'networks/discovery.png'),
            ('Discovery Family', 'http://api.trakt.tv/shows/popular?networks=Discovery Family&limit=100&page=1', 'networks/discoveryfam.png'),
            ('Discovery ID', 'http://api.trakt.tv/shows/popular?networks=Investigation Discovery&limit=100&page=1', 'networks/id.png'),
            ('Disney Channel', 'http://api.trakt.tv/shows/popular?networks=Disney Channel&limit=100&page=1', 'networks/disney.png'),
            ('Disney XD', 'http://api.trakt.tv/shows/popular?networks=Disney XD&limit=100&page=1', 'networks/disneyxd.png'),
            ('DIY', 'http://api.trakt.tv/shows/popular?networks=DIY Network&limit=100&page=1', 'networks/diy.png'),
            ('E! Entertainment', 'http://api.trakt.tv/shows/popular?networks=E!&limit=100&page=1', 'networks/e!.png'),
            ('Food Network', 'http://api.trakt.tv/shows/popular?networks=Food Network&limit=100&page=1', 'networks/food.png'),
            ('FOX', 'http://api.trakt.tv/shows/popular?networks=FOX', 'networks/fox.png'),
            ('FX', 'http://api.trakt.tv/shows/popular?networks=FX', 'networks/fx.png'),
            ('FXx', 'http://api.trakt.tv/shows/popular?networks=FXX', 'networks/fxx.png'),
            ('Freeform', 'http://api.trakt.tv/shows/popular?networks=Freeform&limit=100&page=1', 'networks/freeform.png'),
            ('Hulu', 'http://api.trakt.tv/shows/popular?networks=Hulu&limit=100&page=1', 'networks/hulu.png'),
            ('HBO', 'http://api.trakt.tv/shows/popular?networks=HBO&limit=100&page=1', 'networks/hbo.png'),
            ('HGTV', 'http://api.trakt.tv/shows/popular?networks=HGTV&limit=100&page=1', 'networks/hgtv.png'),
            ('Hallmark', 'http://api.trakt.tv/shows/popular?networks=Hallmark&limit=100&page=1', 'networks/hallmark.png'),
            ('History Channel', 'http://api.trakt.tv/shows/popular?networks=History&limit=100&page=1', 'networks/history.png'),
            ('IFC', 'http://api.trakt.tv/shows/popular?networks=IFC&limit=100&page=1    18/lifetime', 'networks/ifc.png'),
            ('Lifetime', 'http://api.trakt.tv/shows/popular?networks=Lifetime&limit=100&page=1    18/lifetime', 'networks/lifetime.png'),
            ('MTV', 'https://www.tvmaze.com/networks/22/mtv', 'networks/mtv.png'),
            ('NBC', 'http://api.trakt.tv/shows/popular?networks=NBC&limit=100&page=1', 'networks/nbc.png'),
            ('National Geographic', 'http://api.trakt.tv/shows/popular?networks=National Geographic&limit=100&page=1', 'networks/natgeo.png'),
            ('Netflix', 'http://api.trakt.tv/shows/popular?networks=Netflix&limit=100&page=1', 'networks/netflix.png'),
            ('Nickelodeon', 'http://api.trakt.tv/shows/popular?networks=Nickelodeon&limit=100&page=1', 'networks/nick.png'),
            ('Nick jr', 'https://www.tvmaze.com/networks/206/nick-jr', 'networks/nickjr.png'),
            ('Nicktoons', 'https://www.imdb.com/search/title/?title_type=tv_series&companies=co0167426', 'networks/nicktoons.png'),
            ('Paramount Network', 'http://api.trakt.tv/shows/popular?networks=Paramount Network&limit=100&page=1', 'networks/paramount.png'),
            ('PBS', 'http://api.trakt.tv/shows/popular?networks=PBS&limit=100&page=1', 'networks/pbs.png'),
            ('PBS Kids', 'https://www.imdb.com/search/title/?title_type=tv_series&companies=co0171371', 'networks/pbskids.png'),
            ('Science Channel', 'http://api.trakt.tv/shows/popular?networks=Science Channel&limit=100&page=1', 'networks/science.png'),
            ('Showtime', 'http://api.trakt.tv/shows/popular?networks=Showtime&limit=100&page=1', 'networks/showtime.png'),
            ('Starz', 'http://api.trakt.tv/shows/popular?networks=Starz&limit=100&page=1', 'networks/starz.png'),
            ('Sundance', 'http://api.trakt.tv/shows/popular?networks=Sundance Network&limit=100&page=1', 'networks/sundance.png'),
            ('Syfy', 'http://api.trakt.tv/shows/popular?networks=Syfy&limit=100&page=1', 'networks/syfy.png'),
            ('TBS', 'http://api.trakt.tv/shows/popular?networks=TBS&limit=100&page=1', 'networks/tbs.png'),
            ('TLC', 'http://api.trakt.tv/shows/popular?networks=TLC&limit=100&page=1', 'networks/tlc.png'),
            ('TNT', 'https://www.imdb.com/search/title/?title_type=tv_series,tv_special,tv_miniseries,documentary,tv_short&companies=co0088248', 'networks/tnt.png'),
            ('TV Land', 'http://api.trakt.tv/shows/popular?networks=TV Land&limit=100&page=1', 'networks/tvland.png'),
            ('Travel Channel', 'http://api.trakt.tv/shows/popular?networks=Travel Channel&limit=100&page=1', 'networks/travel.png'),
            ('TruTV', 'https://www.tvmaze.com/networks/84/trutv', 'networks/tru.png'),
            ('USA', 'http://api.trakt.tv/shows/popular?networks=USA Network&limit=100&page=1', 'networks/usa.png'),
            ('VH1', 'http://api.trakt.tv/shows/popular?networks=VH1&limit=100&page=1', 'networks/vh1.png'),
            ('VH1 Classic', 'https://www.imdb.com/search/title/?companies=co0077665', 'networks/vh1c.png'),
            ('YouTube Premium', '/webchannels/43/youtube-premium', 'networks/youtube.png')
        ]

        for i in networks:
            self.list.append({'name': i[0], 'url': i[1], 'image': i[2], 'action': 'tvshows'})
        self.addNetworkDirectory(self.list)
        return self.list
            ...
            try:
                ...
                self.list.append(
                    {'title': title, 'originaltitle': title, 'year': year, 'premiered': premiered, 'studio': studio,
                     ...
                     'plot': plot, 'imdb': imdb, 'tvdb': tvdb, 'poster': '0', 'next': next})
            except:
                pass
    ...
    def imdb_list(self, url):
        ...
        for item in items:
            try:
                ...
                self.list.append(
                    {'title': title, 'originaltitle': title, 'year': year, 'rating': rating, 'plot': plot,
                     'imdb': imdb, 'tvdb': '0', 'poster': poster, 'next': next})
            except:
                pass
    ...
    def super_info(self, i):
        try:
            ...
            try:
                ...
                art = client.request(
                    self.fanart_tv_art_link % tvdb, headers=self.fanart_tv_headers, timeout='10', error=True)
                try:
                    art = json.loads(art)
                except:
                    artmeta = False
    ...
    def tvshowDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                cm.append(
                    ('Find similar', 'ActivateWindow(10025,%s?action=tvshows&url=https://api.trakt.tv/shows/%s/related,return)' %
                     (sysaddon, imdb)))

                cm.append(
                    (playRandom, 'RunPlugin(%s?action=random&rtype=season&tvshowtitle=%s&year=%s&imdb=%s&tvdb=%s)' %
    ...
    def addDirectory(self, items, queue=False):
        ...
        for i in items:
            try:
                ...
                cm.append(
                    (playRandom, 'RunPlugin(%s?action=random&rtype=show&url=%s)' %
                ...
                try:
                    cm.append(
                        (addToLibrary, 'RunPlugin(%s?action=tvshowsToLibrary&url=%s)' %
        ...
        control.directory(syshandle, cacheToDisc=True)
        views.setView('tvshows', {'skin.scorpion': 500, 'skin.confluence': 500})
        
    def addNetworkDirectory(self, items, queue=False):
        if items is None or len(items) == 0:
            control.idle()
            sys.exit()
        ...
        control.content(syshandle, 'networks')
        control.directory(syshandle, cacheToDisc=True)
        views.setView('networks', {'skin.scorpion': 500, 'skin.confluence': 500})
