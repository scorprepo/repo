...
"""
    **Created by Scorpion**
    **If you see this in a addon other than Scorpion and says it was
    created by someone other than Scorpion they stole it from me**
"""
    ...
    def sources(self, url, hostDict, hostprDict):
        ...
        try:
            ...
            try:
                ...
                for post in posts:
                    seeders = re.compile('<td class="seeds is-hidden-sm-mobile">(.+?)</td>').findall(post)[0]
